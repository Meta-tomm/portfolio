...
// 3D Card Context for mouse position tracking
...
export const CardContainer = ({ children, className, containerClassName, ...rest }: CardContainerProps) => {
...
interface CardItemProps extends Omit<HTMLAttributes<HTMLElement>, 'as'> {
